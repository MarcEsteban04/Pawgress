...
| ~~Streaming transport for the assistant~~ | **Resolved in Sprint 37** — a route handler streaming NDJSON. A Server Action cannot be aborted, so a student who navigates away keeps paying for tokens they will never read |
